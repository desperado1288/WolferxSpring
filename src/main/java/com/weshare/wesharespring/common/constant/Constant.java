...
public class Constant {
    ...
    public static final String  ACCESS_CONTROL_ALLOW_HEADERS = "Origin, X-Requested-With, X-Prototype-Version, Content-Type, Cache-Control, Pragma, Accept";
     ...
     * Profile
     */
    public static final Integer PROFILE_STATUS_NORMAL = 0;
    public static final Integer PROFILE_STATUS_PROVIDER_PENDING = 1;
    public static final Integer PROFILE_STATUS_PROVIDER_APPROVED = 1;
